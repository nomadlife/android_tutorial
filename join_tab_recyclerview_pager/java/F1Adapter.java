...
public class F1Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private ArrayList<Movie> pagerList;
    ...
    public F1Adapter(FragmentManager fragmentManager, ArrayList<Movie> data1, ArrayList<Movie> data2) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        if (viewType==0) {
            View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.f1_row, viewGroup, false);
            return new ViewHolder(v);
        } else {
            View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.f1_image_type2, viewGroup, false);
...
//            int margin = 80;
            ...
            ((ViewHolder2)viewHolder).textView.setText(movieList.get(i-1).getMovieTitle());
            ((ViewHolder2)viewHolder).imageView.setImageResource(movieList.get(i-1).getImageResourceID());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            vp = itemView.findViewById(R.id.f1_viewPager);
        }
    }
    ...
    public static class ViewHolder2 extends RecyclerView.ViewHolder {
        ...
        public ViewHolder2(View itemView) {
            super(itemView);
            textView = itemView.findViewById(R.id.f1_textView);
            imageView = itemView.findViewById(R.id.f1_imageView);
        }
    }
